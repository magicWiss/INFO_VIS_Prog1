...
function updateBalls(view) {
    ...
    svg.selectAll(".circles")
        ...
        .transition()
        .duration(duration)
        .attr("cx", function(d){console.log("original value X: ",d["x"+view]);console.log("new value:",xScale(d["x" + view]));return xScale(d["x" + view])})
        .attr("cy",function(d){console.log("original value Y: ",d["y"+view]);console.log("new value:",yScale(d["y" + view]));return yScale(d["y" + view])});
...
function updateDrawing(data, view) {
    ...
    circles.enter()
        ...
        .attr("cx",function(d){return xScale(d["x"+view])})
        .attr("cy",function(d){return yScale(d["y"+view])})
